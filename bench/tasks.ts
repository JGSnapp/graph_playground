...
ничего не удаляя и не добавляя — те же узлы, те же связи, только читаемо.`,
  ...
  {
    id: 'tight-row',
    probes: 'особое требование: плотный ряд вопреки правилам по умолчанию',
    graph: false,
    prompt: `Поставь пять карточек строго в один горизонтальный ряд и вплотную друг к другу:
зазор между соседями ровно 8px, все на одной высоте. Карточки: «Понедельник», «Вторник»,
«Среда», «Четверг», «Пятница», в каждой одна строка с планом на день.
Это осознанное требование — плотно и в ряд, никакого «воздуха» добавлять не надо.`,
  },
  {
    id: 'overlap-stack',
    probes: 'особое требование: намеренное перекрытие блоков',
    graph: false,
    prompt: `Разложи шесть карточек-фотографий стопкой внахлёст, как разбросанные снимки:
каждая следующая перекрывает предыдущую примерно на четверть и немного смещена вниз.
Подписи: «Отпуск 2019», «Свадьба», «Выпускной», «Переезд», «Первый проект», «Новый год».
Перекрытие здесь задумано, так и должно быть.`,
  },
  {
    id: 'wide-timeline',
